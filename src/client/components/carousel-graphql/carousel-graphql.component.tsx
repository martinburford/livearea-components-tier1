...
// Types
import { ICarouselGraphql } from "./carousel-graphql.types";

export const CarouselGraphql: React.FC<ICarouselGraphql> = ({ compact=false, delay, name: carouselName, speed }) => {
...
export default CarouselGraphql;
